        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-7">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Suspected Cases by Province</span>
            ...
            <div class="card-body pt-7">
                <!--begin::Filters-->
                <form action="{{ route('getSuspectedCasesByProvince') }}" method="GET" class="mb-8">
                    <div class="row g-5">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="province" class="form-select form-select-solid" data-control="select2"
                                ...
                                @foreach ($suspectedCasesByProvince->unique('province') as $caseData)
                                    <option value="{{ $caseData->province ?? '' }}"
                                        {{ request('province') == ($caseData->province ?? '') ? 'selected' : '' }}>
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        <thead>
                            <tr class="fw-bold text-muted bg-light">
                                <th class="min-w-150px rounded-start">Province</th>
                                <th class="min-w-150px">Suspected Disease</th>
                                <th class="min-w-100px rounded-end">Suspected Count</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($suspectedCasesByProvince as $caseData)
                                <tr>
                                    <td class="fw-semibold text-gray-800">{{ $caseData->province ?? 'N/A' }}</td>

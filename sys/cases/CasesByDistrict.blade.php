        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-7">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Suspected Cases by District</span>
                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Overview of suspected disease cases across
                        districts</span>
                </h3>
                <!--end::Title-->
                <!--begin::Toolbar-->
            ...
            <div class="card-body pt-7">
                <!--begin::Filters-->
                <form action="{{ route('getSuspectedCasesByDistrict') }}" method="GET" class="mb-8">
                    <div class="row g-5">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="district" class="form-select form-select-solid" data-control="select2"
                                ...
                                @foreach ($suspectedCasesByDistrict->unique('district') as $caseData)
                                    <option value="{{ $caseData->district ?? '' }}"
                                        {{ request('district') == ($caseData->district ?? '') ? 'selected' : '' }}>
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        <thead>
                            <tr class="fw-bold text-muted bg-light">
                                <th class="min-w-150px rounded-start">District</th>
                                <th class="min-w-150px">Suspected Disease</th>
                                <th class="min-w-100px rounded-end">Suspected Count</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($suspectedCasesByDistrict as $caseData)
                                <tr>
                                    <td class="fw-semibold text-gray-800">{{ $caseData->district ?? 'N/A' }}</td>
